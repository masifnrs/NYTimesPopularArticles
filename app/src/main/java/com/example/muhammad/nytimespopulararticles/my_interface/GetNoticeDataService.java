package com.example.muhammad.nytimespopulararticles.my_interface;
...
public interface GetNoticeDataService {
    ...
    @GET("all-sections/7.json")//("bins/1bsqcn/")
    Call<ArticleList> getNoticeData(@Query("api_key") String apiKey);
     ...
     * */
    @GET("bins/path/")
    Call<ArticleList> getNoticeDataData(@Query("company_no") int companyNo);
