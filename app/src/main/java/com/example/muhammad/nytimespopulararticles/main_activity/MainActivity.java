...
import com.example.muhammad.nytimespopulararticles.adapter.ArticleAdapter;
...
public class MainActivity extends AppCompatActivity implements MainInterface.MainView {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        presenter = new PresenterImpl(this, new DataIntractorImpl());
    ...
    private RecyclerItemClickListener recyclerItemClickListener = new RecyclerItemClickListener() {
        @Override
        public void onItemClick(Article notice) {
    ...
    @Override
    public void setDataToRecyclerView(ArrayList<Article> noticeArrayList) {

        ArticleAdapter adapter = new ArticleAdapter(noticeArrayList , recyclerItemClickListener);
